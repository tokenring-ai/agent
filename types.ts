...
type RequiredAgentCommandArgumentKeys<Schema extends AgentCommandArgumentsSchema> = {
  [Key in keyof Schema]: Schema[Key]["required"] extends true ? Key : AgentCommandArgumentHasDefault<Schema[Key]> extends true ? Key : never;
}[keyof Schema];

type OptionalAgentCommandArgumentKeys<Schema extends AgentCommandArgumentsSchema> = Exclude<keyof Schema, RequiredAgentCommandArgumentKeys<Schema>>;
...
type OptionalAgentCommandPositionals<Schema extends readonly AgentCommandPositionalSchema[]> = Exclude<Schema[number], RequiredAgentCommandPositionals<Schema>>;
...
type AgentCommandRemainderInput<Schema extends AgentCommandInputSchema> = Schema["remainder"] extends AgentCommandRemainderSchema
  ? {
      remainder: Schema["remainder"]["required"] extends true ? string : Schema["remainder"]["defaultValue"] extends string ? string : string | undefined;
    }
  : { remainder?: never };
